...
[![Quality](https://img.shields.io/badge/Quality-Production%20Ready-success?style=flat-square)](./reports/evaluation_report.md)
[![Evaluation](https://img.shields.io/badge/Evaluation-Dual--Track-blue?style=flat-square)](./reports/evaluation_report.md)
[![Certified](https://img.shields.io/badge/Certified-36-brightgreen?style=flat-square)](./reports/evaluation_report.md)
...
📈 [View Full Evaluation Report →](./reports/evaluation_report.md)
<!-- STATS_END -->
...
**📖 详细贡献报告**：[Project Evolution](./PROJECT_CONFIG.md) | [Quality Assessment](./reports/evaluation_report.md)
...
📊 **查看完整评估数据**：[Evaluation Report (HTML)](./reports/evaluation_report.md) | [Raw Data (JSON)](./reports/evaluation_report.json)
...
基于[双轨评估体系](./reports/evaluation_report.md)，以下Skill达到认证标准：
...
| ... | [查看全部36个认证Skill →](./reports/evaluation_report.md) | | | | |
...
**[🌐 Website](https://theneoai.github.io/awesome-skills/)** • **[📊 Evaluation Report](https://theneoai.github.io/awesome-skills/reports/evaluation_report.md)** • **[📚 Catalog](./CATALOG.md)** • **[🗺️ Roadmaps](./roadmap/)**
