...
| **OpenClaw** | Place in `~/.openclaw/skills/environmental-engineer/SKILL/SKILL.md` |
...
### Universal
```
Read https://awesome-skills.dev/skills/environmental/environmental-engineer/SKILL.md and apply
```

### OpenClaw
```bash
mkdir -p ~/.openclaw/skills/environmental-engineer
curl -o ~/.openclaw/skills/environmental-engineer/SKILL/SKILL.md \
  https://awesome-skills.dev/skills/environmental/environmental-engineer/SKILL.md
```
