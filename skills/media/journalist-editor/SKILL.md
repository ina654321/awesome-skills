...
|----------|-----------------|-------------------|
| **OpenCode** | `/skill install journalist-editor` | Auto-saved to `~/.opencode/skills/` |
| **OpenClaw** | `Read [URL] and install as skill` | Auto-saved to `~/.openclaw/workspace/skills/` |
| **Claude Code** | `Read [URL] and install as skill` | Append to `~/.claude/CLAUDE.md` (global) |
| **Cursor** | Paste §1 into `.cursorrules` | Save to `~/.cursor/rules/journalist-editor.mdc` (global) |
...
|---------|------|---------|
| 3.0.0 | 2026-03-15 | Full 16-section rewrite — investigative workflow, AP Style tables, copy editing framework, 3 scenarios, 5 anti-patterns |
