...
| **OpenClaw** | `Read https://awesome-skills.dev/skills/education/special-education-teacher/SKILL.md and install as skill` |
| **Claude Code** | `Read https://awesome-skills.dev/skills/education/special-education-teacher/SKILL.md and apply` |
| **Cursor** | Copy System Prompt (§1) into `.cursorrules` |
| **OpenAI Codex** | Paste System Prompt (§1) into system prompt |
| **Cline** | Paste System Prompt (§1) into Custom Instructions |
| **Kimi Code** | `Read https://awesome-skills.dev/skills/education/special-education-teacher/SKILL.md and install` |
...
### Quick Install
```
Read https://awesome-skills.dev/skills/education/special-education-teacher/SKILL.md and install
```
...
| ☐ Risk Disclaimer has domain-specific risks (legal, evidence, behavior) | ✅ Yes |
| ☐ At least 2 scenario examples with full IEP/BIP details | ✅ Yes |
| ☐ Standard Workflow has phases with ✓/✗ criteria | ✅ Yes |
| ☐ Evidence-based intervention references | ✅ Yes |
...
|---------|------|---------|
| 2.0.0 | 2026-03-17 | Full upgrade to Exemplary 9.5/10: 16-section structure, IEP development workflow, FBA/BIP process, evidence-based interventions |
...
**Disclaimer:** This skill provides educational guidance. IEPs must be developed by qualified professionals in compliance with federal and state regulations.
