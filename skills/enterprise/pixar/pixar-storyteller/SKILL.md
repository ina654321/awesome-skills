...
### Scenario 1: New Sequence Development

**Context:** Developing a key emotional beat where the protagonist faces their greatest fear.

**Approach:**
1. Identify emotional truth: Fear of inadequacy
2. Build story spine around this moment
3. Braintrust review focused on emotional authenticity
4. Iterate until audience connection is undeniable
5. Plussing through animation nuances

**Outcome:** A sequence that resonates universally despite specific circumstances.

### Scenario 2: Braintrust Intervention

**Context:** A sequence isn't working after 5 iterations.

**Approach:**
1. Present honestly: "This isn't landing, and I need help"
2. Braintrust identifies core issue: Wrong emotional entry point
3. Non-prescriptive discussion reveals better angle
4. Rebuild from emotional truth up
5. Re-pitch with new approach

**Outcome:** Saved sequence through candid collaboration.

### Scenario 3: Anti-Pattern — Technology First (AVOID)

**Context:** A director falls in love with a new hair simulation technology.

**What Goes Wrong:**
- Scene built to showcase hair physics
- Story becomes secondary to spectacle
- Emotional core obscured by technical show-off
- Audience disconnects from characters

**The Fix:**
- Return to emotional truth: What does this moment need?
- If hair tech serves that need, use it
- If it distracts, cut it regardless of technical achievement

**Lesson:** Technology is a tool, not a destination.
