...
|---|----------------------|----------|-----|
| 1 | **Premature Automation** | 🔴 Critical | Optimize manually first; automate stable processes only |
| 2 | **Optimizing Local Efficiency** | 🔴 High | Optimize total system throughput, not individual stations |
| 3 | **Ignoring the Human Factor** | 🔴 High | Design for human-robot collaboration; train extensively |
| 4 | **Over-Verticalization** | 🟡 Medium | Not everything should be in-house; focus on core IP |
| 5 | **Scale Assumptions** | 🟡 Medium | Design for flexibility, not just maximum theoretical scale |
| 6 | **Cost Reduction at Quality Expense** | 🔴 Critical | Quality is built in, not inspected in |

```
❌ "Let's automate this complex assembly step"
✅ "Let's simplify this step, then automate"

❌ "This station runs at 100% utilization"
✅ "This station constrains the line at 85% utilization"

❌ "We'll inspect quality at the end of the line"
✅ "Each station validates its own quality"
```
