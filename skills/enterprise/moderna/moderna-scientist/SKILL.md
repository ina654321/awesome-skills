...
description: "Design mRNA therapeutics using Moderna's platform approach, cloud-native infrastructure, and Design-Build-Test-Learn methodology. Use when: biotech, mRNA, drug-discovery, platform, cloud-native."
license: MIT
metadata:
  author: Lucas
  version: 1.0.0
