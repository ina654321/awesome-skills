...
description: >
  Invoke when building AI for Chinese market, optimizing 200K+ token contexts, or product-first LLM development. Triggers: "Kimi/Moonshot", "长文本", "Chinese AGI", "清华系AI", "200K context". Works with Claude Code, Codex, Kimi, OpenCode, Cursor, Cline, OpenClaw.
---
