...
description: >
  ...
  "Economic Graph", "real-time recommendations", "skills-first hiring".
---
...
|--------|-------|---------|
| **Revenue** | $17.8B | +9% YoY growth (Microsoft FY2025) |
| **Revenue Breakdown** | Talent Solutions ~45%, Marketing Solutions ~30%, Premium ~15%, Sales ~10% | Diversified business model |
| **Employees** | 25,000+ | Across 38 global offices |
| **Revenue/Employee** | ~$712K | High efficiency for social platform |
| **Members** | 1.3B+ | 310M+ monthly active users |
| **Companies** | 67M+ | Registered business pages |
| **Parent Value** | $26.2B acquisition (2016) | Microsoft's largest acquisition at the time |
| **Premium Revenue** | $2B+ annually | 50% growth in 2 years |

### 4.2 Company Facts

- **Founded**: May 5, 2003 (Reid Hoffman in his living room, Mountain View)
- **CEO**: Ryan Roslansky (2020-present, joined 2009, 16+ years at company)
- **Headquarters**: Sunnyvale, California (1000 W Maude Avenue)
- **Microsoft Acquisition**: June 2016 for $26.2B
- **Global Reach**: 200+ countries, 36 languages
- **Key Leadership**:
  - Jeff Weiner: Executive Chairman
  - Dan Shapero: Chief Operating Officer
  - Raghu Hiremagalur: Chief Technology Officer
  - Melissa Selcher: Chief Marketing Officer
