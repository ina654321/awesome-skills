...
### 2.1 · BCG Firm Intelligence (2024-2025)

| Metric | Value | Context |
|--------|-------|---------|
| **2024 Revenue** | $13.5 billion | 10% YoY growth, 21 consecutive years of growth |
| **Employees** | 33,000+ worldwide | Global headcount rising |
| **Offices** | 100+ cities | 50+ countries |
| **AI Revenue** | ~20% of total | Fastest-growing segment |
| **Client Base** | 2/3 of Fortune 500 | CEO and board-level access |

**Key Milestones:**
- **1963:** Founded by Bruce Henderson as management consulting division of Boston Safe Deposit and Trust Company
- **1966:** Experience Curve introduced; Tokyo office opens (first international)
- **1968:** Growth-Share Matrix developed
- **1973:** Bill Bain departs to found Bain & Company
- **1998:** BCG Henderson Institute (strategy think tank) launched
- **2014:** BCG Digital Ventures founded
- **2015:** BCG Gamma (AI/ML) launched
- **2021:** Christoph Schweizer becomes CEO
- **2022:** BCG X formed (Digital Ventures + Gamma + Platinion)
- **2024:** Center for Geopolitics launched; record $13.5B revenue
- **2025:** Christoph Schweizer re-elected to second 4-year term

### 2.2 · BCG Specialized Divisions

| Division | Focus | Capabilities |
|----------|-------|--------------|
| **BCG X** | Tech Build & Design | 3,000+ experts in AI, digital products, venture building |
| **BCG Gamma** | Advanced Analytics | AI/ML, predictive modeling, data science |
| **BCG Platinion** | IT Architecture | Enterprise architecture, cybersecurity, cloud implementation |
| **BCG BrightHouse** | Organizational Purpose | Purpose-driven strategy, culture transformation |
| **BCG Center for Geopolitics** | Risk Advisory | Geopolitical strategy, trade policy, scenario planning |
| **BCG Henderson Institute** | Thought Leadership | Strategic research, innovation in business theory |

**BCG X Partnership Ecosystem:**
- AI Leaders: Anthropic, OpenAI, Google, Microsoft
- Cloud: AWS, Azure, GCP
- Enterprise: Salesforce, SAP, IBM

### 2.3 · BCG Framework Library

#### The Growth-Share Matrix (1970)

The seminal portfolio analysis framework:
...
```
        ...
        - Selective invest  │  - Invest to
        - Build or divest   │    maintain
                            │    leadership
    LOW ────────────────────┼──────────────────── HIGH
    RELATIVE                │                MARKET
    MARKET                  │                SHARE
    SHARE                   │
        ...
        (Low Growth,        │  (Low Growth,
         Low Share)         │   High Share)
        - Harvest,          │  - Harvest to
          divest, or        │    fund stars
          reposition        │  - Minimize
                            │    investment
                           LOW
```

**Strategic Imperatives by Quadrant:**

| Quadrant | Cash Flow | Strategy | Investment Priority |
|----------|-----------|----------|---------------------|
| **Stars** | Neutral | Build, maintain leadership | High |
| **Cash Cows** | Positive | Harvest, optimize cash | Low |
| **Question Marks** | Negative | Selective build OR divest | Medium-High |
| **Dogs** | Neutral/Negative | Harvest, divest, reposition | None |
...
1. Cost leadership requires aggressive pursuit of market share
2. First-movers can build sustainable cost advantages
3. Pricing should anticipate competitor cost positions
4. Volume investments pay off through experience accumulation

#### Time-Based Competition (1980s)

Competitive advantage through **speed** in product development, manufacturing, and market response.
...
- Being first to market captures disproportionate value

#### Rule of Three and Four

**Finding:** Stable competitive markets typically converge to 3-4 major players with balanced market shares.
...
### 2.4 · MBB Comparison Context

| Dimension | McKinsey | BCG | Bain |
|-----------|----------|-----|------|
| **Founded** | 1926 | 1963 | 1973 |
| **Employees** | ~38,000 | ~33,000 | ~22,000 |
| **2024 Revenue** | ~$16B | $13.5B | ~$7B |
| **Known For** | Global prestige, alumni network | Innovation, frameworks, digital | Private equity, culture, results |
| **Culture** | Structured, formal, up-or-out | Intellectual, collaborative | Team-oriented, entrepreneurial |
...
### 2.5 · Notable BCG Alumni

| Name | Role | BCG Tenure |
|------|------|------------|
| **Jeff Immelt** | Former CEO, General Electric | Consultant |
| **Indra Nooyi** | Former CEO, PepsiCo | 1980-1986 |
| **Eric Ries** | Author, The Lean Startup | Consultant |
| **Bill Bain** | Founder, Bain & Company | 1967-1973 |
| **John Clarkeson** | Former BCG CEO | 1960s-1990s |

---

## §3 · WORKFLOW

### BCG Project Lifecycle

```
┌─────────────────────────────────────────────────────────────────────┐
│                    BCG ENGAGEMENT WORKFLOW                          │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  ┌─────────────┐    ┌─────────────┐    ┌─────────────────────┐     │
│  │   PHASE 1   │───▶│   PHASE 2   │───▶│      PHASE 3        │     │
│  │   DIAGNOSE  │    │   ANALYZE   │    │    SYNTHESIZE       │     │
│  └─────────────┘    └─────────────┘    └─────────────────────┘     │
│         │                  │                      │                 │
│         ▼                  ▼                      ▼                 │
│  • Problem framing    • Hypothesis testing    • Strategic options   │
│  • Context setting    • Data collection       • Trade-off analysis  │
│  • Success metrics    • Framework application • Board-ready output   │
│  • Stakeholder map    • Benchmarking          • Stakeholder buy-in  │
│                                                                     │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │                        PHASE 4                              │   │
│  │                      RECOMMEND                              │   │
...
│  │   ACTIVATE  │    │  • Executive Summary (answer first)     │    │
│  └─────────────┘    │  • Strategic Analysis & Frameworks      │    │
│                     │  • Financial Impact Assessment            │    │
│  • Implementation   │  • Implementation Roadmap                 │    │
│    roadmap          │  • Risk Assessment & Mitigations          │    │
│  • KPIs & metrics   │  • Appendices (detailed analysis)         │    │
│  • Governance model └─────────────────────────────────────────┘    │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
- [ ] Alternatives have been considered and evaluated
- [ ] Financial impact is quantified where possible
...
### Example 1: Market Entry Strategy (Robotic Surgery)
...
### Example 4: AI Strategy & Digital Transformation

**Client Situation:**
Legacy financial services firm ($5B AUM) facing disruption from fintech competitors. AI adoption minimal. Need comprehensive AI transformation roadmap to compete with digital-native players.
...
**BCG AI Opportunity Framework:**

| Function | AI Use Case | Value Potential | Implementation Complexity |
|----------|-------------|-----------------|---------------------------|
| Customer Service | AI chatbots, virtual assistants | $15M/year | Low |
| Risk Management | Fraud detection, credit scoring | $25M/year | Medium |
| Wealth Management | Portfolio optimization, robo-advisory | $40M/year | High |
| Operations | Process automation, RPA | $20M/year | Low-Medium |
| Marketing | Personalization, churn prediction | $18M/year | Medium |
...
- Data platform build
- AI pilot programs (2 use cases)
- Agile transformation (2 pilot teams)

**Phase 2: Acceleration (Months 12-24) — $40M**
- AI-powered customer service rollout
- Process automation (RPA) at scale
- Advanced analytics platform
- Scale agile (20 teams)

**Phase 3: Scale (Months 24-36) — $35M**
- Full robo-advisory platform
- Open banking/APIs
- AI-powered risk management
- Digital-native product launch

**BCG Recommendation:**
> Pursue **hybrid approach**: License platform for speed-to-market ($30M), build differentiating AI capabilities in-house ($50M), and establish strategic partnership for data enrichment ($20M). Total investment: $100M over 3 years. Target 50% digital channel share, $118M annual AI value capture, and 25% customer acquisition growth.

---

### Example 5: Pricing Strategy & Value Capture
...
### 5.1 · Problem Structuring: Issue Trees
...
### 5.2 · Investment Prioritization Matrix
...
### 5.5 · Executive Presentation Structure
...
6. **AI Strategy:**
   > "How would BCG X approach AI transformation for this company?"
...
### Modern BCG Thinking
- BCG Henderson Institute publications (bcghendersoninstitute.com)
...
- See `references/bcg-frameworks.md` for expanded framework library
- See `references/case-examples.md` for additional case studies
