...
description: 'LangChain expert: LCEL (LangChain Expression Language), chains, agents,
  RAG pipelines, tool calling, memory, callbacks, output parsers, retrieval strategies.
  Use when building LLM applications, RAG systems, or AI agents with LangChain.'
license: MIT
metadata:
