...
**[URL]:** `https://awesome-skills.dev/skills/tools/database/postgresql-expert.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/tools/database/postgresql-expert.md and install as skill
```
