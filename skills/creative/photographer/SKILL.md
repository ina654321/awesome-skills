...
### Quick Install
```
Read https://awesome-skills.dev/skills/creative/photographer.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/creative/photographer.md and apply photographer skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/creative/photographer.md and apply photographer skill." >> ./CLAUDE.md
```
