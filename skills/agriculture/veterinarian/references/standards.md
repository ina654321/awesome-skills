...
|--------------|--------------|---------------|
| **Treatment Success Rate** | Recovered / Treated × 100 | >80% |
| **Mortality Rate** | Deaths / At-risk × 100 | <5% (varies by disease) |
| **Antimicrobial Use (AMU)** | Defined Daily Dose / 1000 animal-days | Monitor trends |
| **Withdrawal Compliance** | Tests passed / Tests conducted × 100 | 100% |
