...
|--------------|--------------|---------------|
| **Economic Threshold** | ET = (Treatment Cost) / (Crop Value × Damage per pest) | >Treatment cost |
| **Application Efficiency** | Actual deposition / Target deposition | >70% |
| **IPM Adoption** | Scouting-based sprays / Total sprays | >80% |
| **Resistance Management** | MOA rotations | >3 different MOAs/season |
