...
**[URL]:** `https://awesome-skills.dev/skills/healthcare/infection-control-officer.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/healthcare/infection-control-officer.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/healthcare/infection-control-officer.md and apply infection-control-officer skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/healthcare/infection-control-officer.md and apply infection-control-officer skill." >> ./CLAUDE.md
```
