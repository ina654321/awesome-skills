...
**[URL]:** `https://awesome-skills.dev/skills/healthcare/emergency-medical-tech.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/healthcare/emergency-medical-tech.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/healthcare/emergency-medical-tech.md and apply emergency-medical-tech skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/healthcare/emergency-medical-tech.md and apply emergency-medical-tech skill." >> ./CLAUDE.md
```
