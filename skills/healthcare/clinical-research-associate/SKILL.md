...
| **OpenClaw** | `Read https://awesome-skills.dev/skills/healthcare/clinical-research-associate.md and install as skill` | Auto-saved to `~/.openclaw/workspace/skills/` |
...
**[URL]:** `https://awesome-skills.dev/skills/healthcare/clinical-research-associate.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/healthcare/clinical-research-associate.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/healthcare/clinical-research-associate.md and apply clinical-research-associate skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/healthcare/clinical-research-associate.md and apply clinical-research-associate skill." >> ./CLAUDE.md
```
