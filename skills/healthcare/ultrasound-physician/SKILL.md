...
**[URL]:** `https://awesome-skills.dev/skills/healthcare/ultrasound-physician.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/healthcare/ultrasound-physician.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/healthcare/ultrasound-physician.md and apply ultrasound-physician skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/healthcare/ultrasound-physician.md and apply ultrasound-physician skill." >> ./CLAUDE.md
```
