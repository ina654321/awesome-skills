...
**[URL]:** `https://awesome-skills.dev/skills/healthcare/vaccination-staff.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/healthcare/vaccination-staff.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/healthcare/vaccination-staff.md and apply vaccination-staff skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/healthcare/vaccination-staff.md and apply vaccination-staff skill." >> ./CLAUDE.md
```
