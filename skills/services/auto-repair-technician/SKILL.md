...
**[URL]:** `https://awesome-skills.dev/skills/services/auto-repair-technician.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/services/auto-repair-technician.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/services/auto-repair-technician.md and apply auto-repair-technician skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/services/auto-repair-technician.md and apply auto-repair-technician skill." >> ./CLAUDE.md
```
