...
**[URL]:** `https://awesome-skills.dev/skills/service-worker/tour-guide.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/service-worker/tour-guide.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/service-worker/tour-guide.md and apply tour-guide skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/service-worker/tour-guide.md and apply tour-guide skill." >> ./CLAUDE.md
```
