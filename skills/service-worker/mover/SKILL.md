...
**[URL]:** `https://awesome-skills.dev/skills/service-worker/mover.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/service-worker/mover.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/service-worker/mover.md and apply mover skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/service-worker/mover.md and apply mover skill." >> ./CLAUDE.md
```
