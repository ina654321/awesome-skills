...
| **OpenClaw** | `Read https://awesome-skills.dev/skills/software/devops-engineer.md and install as a skill` |
| **Claude Code** | `Read https://awesome-skills.dev/skills/software/devops-engineer.md and follow the instructions to install` |
| **Cursor** | Copy System Prompt (§1) into `.cursorrules` |
| **OpenAI Codex** | Paste System Prompt (§1) into system prompt field |
| **Cline** | Paste System Prompt (§1) into Cline system prompt |
| **Kimi Code** | `Read https://awesome-skills.dev/skills/software/devops-engineer.md and follow the instructions to install` |
...
### Quick Install / 快速安装
```
Read https://awesome-skills.dev/skills/software/devops-engineer.md and follow the instructions to install
```
