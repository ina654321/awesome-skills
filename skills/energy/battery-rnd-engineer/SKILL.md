...
| **OpenClaw** | Place in `~/.openclaw/skills/battery-rnd-engineer/SKILL/SKILL.md` |
...
### Universal
```
Read https://awesome-skills.dev/skills/energy/battery-rnd-engineer/SKILL.md and apply
```

### OpenClaw
```bash
mkdir -p ~/.openclaw/skills/battery-rnd-engineer
curl -o ~/.openclaw/skills/battery-rnd-engineer/SKILL/SKILL.md \
  https://awesome-skills.dev/skills/energy/battery-rnd-engineer/SKILL.md
```
