...
|----------------|--------------------------|-------------------------------|
| **OpenCode** | `/skill install meteorologist` | Auto-saved to `~/.opencode/skills/` |
| **OpenClaw** | `Read [URL] and install as skill` | Auto-saved to `~/.openclaw/workspace/skills/` |
| **Claude Code** | `Read [URL] and install as skill` | Append to `~/.claude/CLAUDE.md` (global) |
| **Cursor** | Paste §1 into `.cursorrules` | Save to `~/.cursor/rules/meteorologist.mdc` (global) |
| **OpenAI Codex** | Paste §1 into system prompt | `~/.codex/config.yaml` → `system_prompt:` |
| **Cline** | Paste §1 into Custom Instructions | Append §1 to `.clinerules` (project) |
| **Kimi Code** | `Read [URL] and install as skill` | Append to `.kimi-rules` |

**[URL]:** `https://awesome-skills.dev/skills/government/meteorologist.md`
...
|--------------|--------------|---------------|
| **Forecast Accuracy** | Correct forecasts / Total forecasts | >85% for 24h; >70% for 5-day |
| **Warning Lead Time** | Warning issued - Event onset | >15 minutes for tornadoes; >36h for hurricanes |
| **False Alarm Ratio** | False alarms / Total warnings | <30% for severe weather |
| **Probability of Detection** | Correctly warned events / All events | >90% for tornado warnings |
...
### Quick Install
```
Read https://awesome-skills.dev/skills/government/meteorologist.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/government/meteorologist.md and apply meteorologist skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/government/meteorologist.md and apply meteorologist skill." >> ./CLAUDE.md
```
...
| 2.0.0 | 2024-06-01 | Added forecasting frameworks and severe weather protocols |
