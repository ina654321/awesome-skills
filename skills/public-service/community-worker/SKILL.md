...
**[URL]:** `https://awesome-skills.dev/skills/public-service/community-worker.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/public-service/community-worker.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/public-service/community-worker.md and apply community-worker skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/public-service/community-worker.md and apply community-worker skill." >> ./CLAUDE.md
```
