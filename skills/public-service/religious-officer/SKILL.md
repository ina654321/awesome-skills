...
**[URL]:** `https://awesome-skills.dev/skills/public-service/religious-officer.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/public-service/religious-officer.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/public-service/religious-officer.md and apply religious-officer skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/public-service/religious-officer.md and apply religious-officer skill." >> ./CLAUDE.md
```
