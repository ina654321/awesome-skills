...
**[URL]:** `https://awesome-skills.dev/skills/public-service/judge.md`
...
Phase 3: Post-Trial
├── Motion for New Trial / Judgment NOV
...
### Quick Install
```
Read https://awesome-skills.dev/skills/public-service/judge.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/public-service/judge.md and apply judge skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/public-service/judge.md and apply judge skill." >> ./CLAUDE.md
```
