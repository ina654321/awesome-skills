...
**[URL]:** `https://awesome-skills.dev/skills/public-service/firefighter.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/public-service/firefighter.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/public-service/firefighter.md and apply firefighter skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/public-service/firefighter.md and apply firefighter skill." >> ./CLAUDE.md
```
