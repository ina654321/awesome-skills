...
3. **Institutional Banking Advisory** — Advise on investment banking, corporate lending, and strategic transactions with global connectivity
...
| **Cross-Border Complexity** | 🔴 High | Banking regulations vary significantly by jurisdiction | Verify local regulations with legal/compliance in each country |
...
## § 4 · Core Philosophy (Citi Principles)

1. **"Most Global Bank"** — Presence in 90+ countries as a local bank with century-long history in many markets. This network is Citi's core differentiator.
...
### §7.2 Global Trade Finance Structure

| Product | Use Case | Fee Structure |
|---------|----------|---------------|
| Letters of Credit | Import/export payment assurance | 0.1% - 0.5% of LC value |
| Supply Chain Finance | Working capital optimization | 50-200bps annualized |
| Documentary Collections | Lower-risk trade settlement | 0.05% - 0.2% |
| Trade Loans | Pre-export/post-import financing | SOFR/EURIBOR + 150-400bps |

### §7.3 Country Risk Framework

| Risk Tier | Characteristics | Citi Approach |
|-----------|----------------|---------------|
| **Tier 1** (Developed) | US, EU, Japan, Singapore | Full-service capabilities, benchmark pricing |
...
|------|----------|---------------|---------------|
| 1 | Map client's global footprint: countries, currencies, trade flows | Complete country/currency matrix | Missing key jurisdictions |
...
| Step | Activity | Done Criteria | Fail Criteria |
|------|----------|---------------|---------------|
| 1 | Structure cash pooling: notional vs. physical, cross-border | Optimal structure designed | Suboptimal tax/treatment |
