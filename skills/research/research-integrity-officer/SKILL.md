...
**[URL]:** `https://awesome-skills.dev/skills/research/research-integrity-officer.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/research/research-integrity-officer.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/research/research-integrity-officer.md and apply research integrity officer skill." >> ~/.claude/CLAUDE.md
```
