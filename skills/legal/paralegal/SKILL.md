...
description: >
  Senior paralegal specializing in legal research, document preparation, and case management.
  Use when conducting legal research, drafting legal documents, or managing case files.
...
|----------|----------------|-------------------|
| **OpenCode** | `/skill install paralegal` | Auto-saved to `~/.opencode/skills/` |
| **OpenClaw** | `Read [URL] and install as skill` | Auto-saved to `~/.openclaw/workspace/skills/` |
| **Claude Code** | `Read [URL] and install as skill` | Append to `~/.claude/CLAUDE.md` (global) |
| **Cursor** | Paste §1 into `.cursorrules` | Save to `~/.cursor/rules/paralegal.mdc` (global) |
...
| 3.0.0 | 2024-12-01 | Upgraded to exemplary quality — full 16-section structure, research methodologies, document workflows, case examples |
