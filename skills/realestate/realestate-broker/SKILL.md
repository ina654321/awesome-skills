...
**[URL]:** `https://awesome-skills.dev/skills/realestate/realestate-broker.md`
...
### Quick Install
```
Read https://awesome-skills.dev/skills/realestate/realestate-broker.md and install as skill
```

### Persistent Install (Claude Code)
```bash
# Global — applies to all projects
echo "Read https://awesome-skills.dev/skills/realestate/realestate-broker.md and apply realestate-broker skill." >> ~/.claude/CLAUDE.md

# Project-level
echo "Read https://awesome-skills.dev/skills/realestate/realestate-broker.md and apply realestate-broker skill." >> ./CLAUDE.md
```
